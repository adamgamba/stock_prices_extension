    ...
    var c = [],
      ...
      p = {
        ...
        fireWith: function (b, c) {
          d &&
            (j ? a.once || d.push([b, c]) : (!a.once || !e) && o(b, c));
          return this;
        },
        fire: function () {
        ...
        f(function () {
          ...
          !u ||
            ...
            a.getComputedStyle &&
              ((p.style.marginTop = "1%"),
              (b.pixelMargin =
                (a.getComputedStyle(p, null) || { marginTop: 0 })
                  .marginTop !== "1%")),
  ...
  f.fn.extend({
    ...
    val: function (a) {
        ...
        g = this[0];
      {
        ...
        if (g) {
          c =
            f.valHooks[g.type] || f.valHooks[g.nodeName.toLowerCase()];
          ...
          for (
            ...
            if (
              ...
              (c.data = s.data),
                (c.handleObj = s),
                (o = (
                  (f.event.special[s.origType] || {}).handle ||
                  s.handler
                ).apply(q.elem, g)),
                o !== b &&
                  ((c.result = o),
          ...
          if (
            ...
            o.order.splice(1, 0, "CLASS"),
              (o.find.CLASS = function (a, b, c) {
                if (
                  typeof b.getElementsByClassName != "undefined" &&
                  !c
                )
    ...
    f.extend({
      ...
      ajax: function (a, c) {
        ...
        var d = f.ajaxSetup({}, c),
          e = d.context || d,
          g =
            e !== d && (e.nodeType || e instanceof f) ? f(e) : f.event,
          h = f.Deferred(),
